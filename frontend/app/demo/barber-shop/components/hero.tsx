  ...
  return (
    ...
    >
      ...
      <div className="section-pad relative mx-auto w-full max-w-7xl pb-16 pt-32 md:pb-24 md:pt-40">
        ...
        <h1 className="animate-fade-up-delay-1 mt-4 max-w-4xl font-display text-[clamp(2.75rem,9vw,6.5rem)] leading-[0.92] tracking-tight text-cream">
          {SITE.name}
        </h1>
        <div className="animate-line-grow mt-6 h-px w-24 bg-brass" />
